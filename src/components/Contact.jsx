          ...
          <div className="lg:w-1/2">
            {errors.name && (
              <motion.p
                 initial={{ opacity: 0 }}
                 whileInView={{ opacity: 1 }}
                 className="mb-2 text-sm text-rose-800">{errors.name}</motion.p>
            )}
            <input
              type="text"
              id="name"
          ...
          <div className="lg:w-1/2">
            {errors.email && (
              <motion.p
                 initial={{ opacity: 0 }}
                 whileInView={{ opacity: 1 }}
                 className="mb-2 text-sm text-rose-800">{errors.email}</motion.p>
            )}
            <input
              type="text"
              id="email"
        ...
        <div className="mb-4">
          {errors.message && (
            <motion.p
               initial={{ opacity: 0 }}
               whileInView={{ opacity: 1 }}
               className="mb-2 text-sm text-rose-800">{errors.message}</motion.p>
          )}
          <textarea
            id="message"
            name="message"
